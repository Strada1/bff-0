...
// Movies
router.post('/movies', validate(['title', 'year', 'duration']), MovieController.createMovie); // create movie: POST '/movies' (body)
...
// Comments
router.post('/comments', validate(['author', 'text']), CommentController.createComment); // create comment by movie id: POST 'comments?movieId=12312312' (body)
...
// Categories
router.post('/categories', validate(['title']), CategoryController.createCategory); // create category: POST '/category' (body) | create category categories and in movie categories: POST '/category?movieId=12312312' (body)
